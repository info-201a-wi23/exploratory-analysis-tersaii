...
### Aadil Ali, Jennifer Feng, Sean Morris, Carmen Weatherman
...
universityList <- CollegeScorecard[c(
  3847, 741, 2328, 2997, 772, 763, 1068, 84, 925,
  3849
), ]

uni <- universityList %>%
  select("INSTNM", "TUITIONFEE_IN", "TUITIONFEE_OUT", "PAR_ED_PCT_1STGEN", "GRAD_DEBT_MDN", "RET_FT4", "TUITFTE") %>%
  group_by(INSTNM)

knitr::kable(uni, "pipe", col.name = c("School Name", "In-State Tuition", "Out-Of-State Tuition", "Amount of First-Gen Students", "Median Post-Graduation Debt", "Retention Rate", "Revenue earned"))
```
